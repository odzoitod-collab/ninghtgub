...
const SUPABASE_URL = "https://rdluqkmslfqabrgykmwl.supabase.co";
const SUPABASE_ANON_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJkbHVxa21zbGZxYWJyZ3lrbXdsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzIxMDc2MDIsImV4cCI6MjA4NzY4MzYwMn0.6pJlPR9hYOh82ntZnXbPvUGw27yvAvvRHgvk4rkALeE";
...
export async function loadSiteSettings(): Promise<SiteSettings> {
  try {
    ...
    return {
      support_username: data.support_username || '@NightHubSupport',
