  ...
  return (
    <div className="w-full overflow-x-auto no-scrollbar py-4 pl-4 space-x-4 flex">
      <div className="flex flex-col items-center space-y-1 cursor-pointer min-w-[64px]">
        <div className="w-16 h-16 rounded-full p-[2px] bg-gradient-to-tr from-violet-400 to-violet-600">
      ...
      {topProfiles.map(profile => (
        ...
        >
          <div className="w-16 h-16 rounded-full p-[2px] bg-gradient-to-tr from-violet-400 to-transparent group-hover:from-violet-300 transition-all">
            <img 
