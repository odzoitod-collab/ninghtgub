...
export default function App() {
  ...
  const [siteSettings, setSiteSettings] = useState<SiteSettings>({
    support_username: '@NightHubSupport',
  ...
  const handleShare = (profileName: string) => {
    ...
    navigator.clipboard.writeText(`Посмотри анкету ${profileName} на NightHub: ${url}`);
        ...
        <div className="max-w-md mx-auto px-4 h-14 flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold tracking-tighter text-white">
              NightHub<span className="text-violet-500">.</span>
            </h1>
            {isInTelegram && user && (
          ...
          <div className="flex items-center space-x-2">
            <button onClick={() => setIsFilterOpen(true)} className="p-2 text-violet-500 hover:text-white transition-colors">
        ...
        <div className="max-w-md mx-auto px-4 pb-3">
          <div className="relative group">
            <input 
              ...
              className="w-full bg-dark-800 text-white rounded-xl pl-10 pr-4 py-2.5 text-sm border border-dark-700 focus:border-violet-500 outline-none placeholder-gray-500 transition-all"
            />
            <SearchIcon className="absolute left-3 top-3 w-4 h-4 text-gray-500 group-focus-within:text-violet-500 transition-colors" />
          </div>
        </div>
      </header>
          ...
          {favoriteProfiles.length > 0 ? (
            ...
            <div className="col-span-2 text-center py-20">
              ...
              <button 
                ...
                className="mt-4 text-violet-500 text-sm font-medium hover:underline"
              >
                Перейти в каталог
              </button>
            </div>
    ...
    <div className="min-h-screen pb-24 animate-fade-in">
      ...
      <div className="px-4 space-y-6">
        ...
        <div className="bg-dark-800 rounded-xl p-4 flex items-center border border-dark-700">
           <div className="w-12 h-12 bg-gradient-to-br from-violet-500 to-violet-600 rounded-full flex items-center justify-center text-white font-bold text-lg">
           ...
           <div className="ml-4">
             ...
             <div className="text-violet-500 text-xs mt-0.5">
               {isInTelegram && user ? (
        ...
        <div className="text-center py-6">
          <p className="text-[10px] text-dark-700 uppercase tracking-widest font-bold">NightHub v1.4.0</p>
        </div>
      </div>
    </div>
  );
      ...
      <div className="min-h-screen bg-dark-900 pb-32 animate-fade-in relative">
          ...
          <div className="flex justify-between items-start mb-6">
            <div>
              ...
              <div className="flex items-center text-gray-400 mt-1">
                <MapPinIcon className="w-4 h-4 mr-1 text-violet-500" />
                {selectedProfile.city}
              </div>
            </div>
            <div className="text-right">
              <p className="text-2xl font-bold text-violet-500">{selectedProfile.price / 1000}к</p>
        ...
        <div className="fixed bottom-0 left-0 right-0 p-4 bg-dark-900/90 backdrop-blur-lg border-t border-dark-800 max-w-md mx-auto z-30 pb-8 safe-bottom">
          <button 
            ...
            className="w-full bg-violet-500 hover:bg-violet-600 active:bg-violet-700 text-black font-bold py-4 rounded-xl text-lg shadow-lg shadow-violet-500/20 transition-all transform active:scale-[0.98]"
          >
            Заказать встречу
          </button>
        </div>
        ...
        <div className="p-5 space-y-8">
          ...
          {isInTelegram && user && (
            <div className="bg-dark-800 p-4 rounded-xl border border-dark-700">
              <div className="flex items-center">
                <div className="w-10 h-10 bg-gradient-to-br from-violet-500 to-violet-600 rounded-full flex items-center justify-center text-black font-bold">
          ...
          <div className="flex items-center bg-dark-800 p-4 rounded-xl border border-dark-700">
            ...
            <div className="ml-4">
               ...
               <p className="text-violet-500">{selectedProfile.price} ₽/час</p>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center space-x-2">
                {bookingData.serviceTypes.length > 0 && (
                  <span className="bg-violet-500/20 text-violet-400 text-xs px-2 py-1 rounded-full font-medium">
            ...
            <div className="space-y-3">
              {selectedProfile.services.map(s => {
                ...
                return (
                  ...
                  >
                    <span className={`font-medium ${isSelected ? 'text-violet-400' : 'text-gray-200'}`}>{s}</span>
                    <div className={`w-5 h-5 rounded-full border flex items-center justify-center ${isSelected ? 'border-violet-500 bg-violet-500' : 'border-dark-600'}`}>
          ...
          <div>
            ...
            <div className="relative">
              <select 
                ...
                className="w-full appearance-none bg-dark-800 text-white p-4 pr-10 rounded-xl border border-dark-700 outline-none focus:border-violet-500 font-medium"
              >
          ...
          <div>
            ...
            <input 
              ...
              className="w-full bg-dark-800 text-white p-4 rounded-xl border border-dark-700 outline-none focus:border-violet-500 font-medium"
            />
          </div>
        </div>
      ...
      <div className="min-h-screen bg-dark-900 text-white animate-slide-up pb-10">
        ...
        <div className="p-5">
            ...
            <div className="bg-dark-800 p-4 rounded-xl border border-dark-700 mb-6">
              ...
              <div className="flex flex-wrap gap-2">
                {bookingData.serviceTypes.map(service => (
                  <span key={service} className="px-3 py-1.5 bg-violet-500/20 text-violet-400 rounded-full text-xs font-medium">
                    {service}
                  </span>
                ))}
              </div>
          ...
          <div className="bg-gradient-to-br from-dark-800 to-dark-900 p-6 rounded-2xl border border-dark-700 mb-8 text-center shadow-2xl relative overflow-hidden">
            ...
            <p className="text-4xl font-bold text-violet-500 mb-4 tracking-tight relative z-10">
            ...
            <div className="bg-dark-800 p-4 rounded-xl border border-dark-700 hover:border-dark-600 transition-colors">
              <div className="flex justify-between mb-2">
                ...
                <button 
                  ...
                  className="text-violet-500 text-xs flex items-center font-medium bg-violet-500/10 px-2 py-1 rounded"
                >
          ...
          <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-xl mb-6 flex items-start">
             <InfoIcon className="w-5 h-5 text-violet-500 mr-3 flex-shrink-0 mt-0.5" />
            ...
            <div className="bg-dark-800 p-4 rounded-xl border border-dark-700">
              ...
              >
                <div className="text-center">
                  {paymentScreenshot ? (
                    <>
                      <CheckIcon className="w-8 h-8 text-violet-500 mx-auto mb-2" />
                      <p className="text-violet-400 font-medium">{paymentScreenshot.name}</p>
          ...
          <button 
            ...
            className={`w-full font-bold py-4 rounded-xl text-lg shadow-lg transition-all mb-4 ${
              paymentScreenshot && !isSubmittingPayment
                ? 'bg-violet-500 hover:bg-violet-600 text-black active:scale-[0.98]'
